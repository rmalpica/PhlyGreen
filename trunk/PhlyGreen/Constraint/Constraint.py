...
class Constraint:
    ...
    def EvaluateConstraints(self, WTOoS, DISA, kTO, sTO, CB, ROC, ht, PsAcceleration):
        ...
        self.PWOEI = self.aircraft.performance.OEIClimb(self.WTOoS,self.ConstraintsBeta[1], CB*self.ConstraintsSpeed[1], self.ConstraintsN[2], self.ConstraintsAltitude[1], DISA, self.ConstraintsSpeed[1], self.ConstraintsSpeedtype[1])
