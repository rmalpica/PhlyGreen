...
ioi = ["Range", "Base Phi"]
configs = [
    (396, 1960, "Hybrid", "Finger-Cell-Thermal", 1500, 6000, 800, 0.022, "Mission-FelixFinger"),
    (1280, 1325, "Hybrid", "Finger-Cell-Thermal", 1500, 6000, 800, 0.022, "Mission-FelixFinger"),
    (2361, 547, "Hybrid", "Finger-Cell-Thermal", 1500, 6000, 800, 0.022, "Mission-FelixFinger"),
...
r = RunAll("TESTESTESTESTESTINGHybTradEle-sample"+program)
...
# # r = RunAll("Swp-Rng-Hyb"+program)
# # r.run_config(configs, ooi)

# configs["Powerplant"] = ["Traditional"]
# # r = RunAll("Swp-Rng-Trad"+program)
# # r.run_config(configs, ooi)

# # Sweep RANGE
# configs["Powerplant"] = ["Hybrid"]
# configs["Base Phi"] =[1]
# # r = RunAll("Swp-Rng-Ele"+program)
# # r.run_config(configs, ooi)
