...
configurations_list = {
    ...
    "Cell": ["ThermalModel-Cell-Mega","ThermalModel-Cell","ThermalModel-Cell-Super","ThermalModel-Cell-Ultra"],
    "Range": linspace(400, 3000, 1, dtype=int).tolist(),
    "Payload": linspace(400, 5000, 1, dtype=int).tolist(),
    "Base Phi": (linspace(5, 50, 7, dtype=int) / 100.0).tolist(),
}
