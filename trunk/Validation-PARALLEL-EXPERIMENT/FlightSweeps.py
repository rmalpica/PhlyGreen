...
{argArch} Powerplant |  Mission Profile: {argMission}
{argCell} Cell Model | Phi = {argPhi}
Range = {argRange}km | Payload = {argPayload}kg
- - - - - - - - - - - - - - - - - - - - - - - - - -\n"""
    print(out)
    ...
    #print(powertrain, structures, aerodynamics, performance, mission, weight, constraint)
    #why did it keep complaining about having too many arguments until i removed welltowake???
