...
| `26_turbofan_design.py` | Size an A320-class **turbofan** jet: the constraint diagram in T/W, the pyCycle overall-efficiency / TSFC map, and the compressible (wave-drag) polar | engine map table + design summary |
