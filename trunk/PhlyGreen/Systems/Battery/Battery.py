...
class Battery:
    ...
    def T(self,value):
        self._T = value
        if value < 0 :
            raise BatteryError(f'Fail_Condition_3\nBattery temperature must be positive:\nTemperature: {value}')
