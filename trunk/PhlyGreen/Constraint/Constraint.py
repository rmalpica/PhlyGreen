...
class Constraint:
    ...
    def EvaluateConstraints(self, WTOoS, DISA, kTO, sTO, CB, ht, PsAcceleration):
        ...
        self.PWOEI = self.aircraft.performance.PoWTO(self.WTOoS,self.ConstraintsBeta[2], 1.4*CB*self.ConstraintsSpeed[2], self.ConstraintsN[2], self.ConstraintsAltitude[2], DISA, self.ConstraintsSpeed[2], self.ConstraintsSpeedtype[2])
        ...
        #old#self.PWOEI = self.aircraft.performance.OEIClimb(self.WTOoS,self.ConstraintsBeta[2], 80*0.012, self.ConstraintsN[2], self.ConstraintsAltitude[1], DISA, 80, self.ConstraintsSpeedtype[2])
